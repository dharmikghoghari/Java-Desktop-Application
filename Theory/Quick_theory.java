package theory;
public class Quick_theory extends javax.swing.JFrame {
    public Quick_theory() {
        initComponents();
    }
    ...
    public static void al() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Quick_theory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Quick_theory().setVisible(true);
            }
        });
    }
