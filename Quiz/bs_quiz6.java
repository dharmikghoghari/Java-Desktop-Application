...
public class bs_quiz6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>6.What is the following algorithm?  1. Repeat steps 2 and 3 varying from 0 to n-1 <br> ii. Find the index of the minimum value in a[k] to a[n-1] and store it in m <br> iii. Swap a[k] with a[m].  </html>");
...
// TODO add your handling code here:
    ...
    public static void q2() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bs_quiz6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
