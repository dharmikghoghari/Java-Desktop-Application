...
public class bs_quiz7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton3.setText("(C)Bubble sort");
        ...
        jLabel1.setText("<html>7.Consider a situation where swap operation is very costly. Which of the following sorting algorithms should be preferred so that the number of swap operations are minimized in general?  </html>");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jRadioButton4.isSelected())
            ...
            ans_lbl.setText("  Oops!  The correct answer is D");  
// TODO add your handling code here:
    ...
    public static void q2() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bs_quiz7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
