...
public class bs_quiz3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>3.What is the worst case time complexity of insertion sort where position of the data to be inserted is calculated using binary search?</html>");
...
// TODO add your handling code here:
    ...
    public static void q2() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bs_quiz3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
