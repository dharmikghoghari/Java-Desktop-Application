...
public class bs_quiz8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("(A)Merge sort > Quick sort >Insertion sort > selection sort");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jRadioButton2.setText("(B)insertion sort < Quick sort < Merge sort < selection sort");
        ...
        jRadioButton3.setText("(C)Merge sort > selection sort > quick sort > insertion sort");
        ...
        jRadioButton4.setText("(D)Merge sort > Quick sort > selection sort > insertion sort");
        ...
        jLabel1.setText("<html>8Which is the correct order of the following algorithms with respect to their time Complexity in the best case ? </html>");
...
// TODO add your handling code here:
    ...
    public static void q2() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bs_quiz8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
