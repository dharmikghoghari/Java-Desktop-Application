...
public class bs_quiz5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("(A)Quick sort");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jRadioButton2.setText("(B)Insertion Sort");
        ...
        jRadioButton3.setText("(C)Merge sort");
        ...
        jRadioButton4.setText("(D)Selection sort");
        ...
        jLabel1.setText("<html>5.Which of the following sorting algorithms in its typical implementation gives best performance when applied on an array which is sorted or almost sorted (maximum 1 or two elements are misplaced).</html>");
...
// TODO add your handling code here:
    ...
    public static void q2() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bs_quiz5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
