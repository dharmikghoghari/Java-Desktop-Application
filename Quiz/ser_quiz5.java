...
public class ser_quiz5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton4.setText("(D) Non of the above");
        ...
        jLabel1.setText("<html> 15)To implement Dijkstra’s shortest path algorithm on unweighted graphs so that it runs in linear time, the data structure to be used is:  </html>");
...
// TODO add your handling code here:
    ...
    public static void q2() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ser_quiz5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
